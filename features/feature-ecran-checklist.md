...
- Un bloc est affiché par catégorie dans la checklist (champ category) et pour chaque bloc les items sont affichés les uns en dessous des autres (voir maquette ecran_checklist.png).
