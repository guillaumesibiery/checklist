...
<section class="bg-white dark:bg-gray-800 rounded-2xl border border-primary/10 dark:border-gray-700/50 overflow-hidden transition-colors">
    ...
    <div class="w-full p-4 bg-white dark:bg-gray-800 flex justify-between items-center hover:bg-secondary/50 dark:hover:bg-gray-700 transition-colors cursor-pointer"
        ...
        <div class="flex items-center gap-2">
            ...
            <h2 class="text-lg font-bold text-text-main dark:text-white transition-colors">{title}</h2>
        </div>
        <div class="flex items-center gap-2">
